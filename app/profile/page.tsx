...
import NoPlanFound from "@/components/NoPlanFound";
    ...
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      ...
      {allPlans && allPlans.length > 0 ? (
        <>
          <div className="space-y-8">
            ...
            >
              ...
              <h2 className="text-xl font-bold tracking-tight">
                <span>Your</span>{" "}
                <span className="text-sky-500">Fitness Plans</span>
              </h2>
          ...
          {currentPlan && (
            <div className="relative border border-dashed rounded-lg mt-2 p-6">
              <CornerElements />
              ...
              <Tabs defaultValue="workout" className="w-full">
                <TabsList className="mb-6 w-full grid grid-cols-2 border">
                  <TabsTrigger
                    value="workout"
